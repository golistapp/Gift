// Hum code ko ek function block mein rakhte hain taki variables aapas mein clash na karein
(function() {
    const loginForm = document.getElementById('login-form');
    const loginBtn = document.getElementById('login-btn');
    const errorMsg = document.getElementById('error-msg');

    // Agar user pehle se logged in hai, toh direct admin SPA route par bhejo
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                window.location.href = '?mode=admin'; // NAYA SPA ROUTE
